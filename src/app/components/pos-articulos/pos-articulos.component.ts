...
@Component({
  selector: 'app-pos-articulos',
  templateUrl: './pos-articulos.component.html',
  styleUrls: ['./pos-articulos.component.css']
})
export class PosArticulosComponent implements OnInit {
